    ...
    <div class="kanmo-page">
        ...
        <main class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
            ...
            <form action="{{ route('employee.form.submit') }}" method="POST"
                ...
                <aside class="kanmo-card p-4 lg:sticky lg:top-5">
                    ...
                    <nav class="mt-3 space-y-1" aria-label="Employee form steps">
                        @foreach ([['Identity', 'Employee ID & KTP'], ['Personal Profile', 'Personal data'], ['Contact & Address', 'Contact and residence'], ['Family & Education', 'Family and education data'], ['Tax & Review', 'NPWP and final review'], ['Document Attachment', 'Upload KTP, KK, and Ijazah']] as $index => [$stepTitle, $stepDescription])
                            <button type="button" class="kanmo-step-button" data-step-button
                                data-step-index="{{ $index }}"
                                data-state="{{ $index === 0 ? 'active' : 'idle' }}">
                                <span class="kanmo-step-number">{{ $index + 1 }}</span>
                                <span class="min-w-0">
                                    <span
                                        class="kanmo-step-title block text-sm font-bold text-slate-700">{{ $stepTitle }}</span>
                                    <span
                                        class="mt-0.5 block truncate text-xs text-slate-500">{{ $stepDescription }}</span>
                                </span>
                            </button>
                        @endforeach
                    </nav>
                ...
                <div class="min-w-0">
                    <div
                        class="mb-3 flex items-center justify-between px-1 text-xs font-semibold text-slate-500 lg:hidden">
                        <span data-current-step>Step 1 of 5 </span>
                        <span>Fields marked <span class="text-kanmo-600">*</span> are required<span
                                class="text-kanmo-600">
                    </div>
                            ...
                            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                <div>
                                    ...
                                    <div class="flex flex-col gap-2 sm:flex-row">
                                        <input type="text" id="employee_id" name="employee_id"
                                            value="{{ old('employee_id', $user->employee_id ?? '') }}" maxlength="20"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="ktp_number" name="ktp_number"
                                        value="{{ old('ktp_number', $user->ktp_number ?? '') }}" maxlength="25"
                            ...
                            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                                <div>
                                    ...
                                    <input type="text" id="display_name" name="display_name"
                                        value="{{ old('display_name', $user->display_name ?? '') }}" maxlength="100"
                                ...
                                <div>
                                    <label for="gender" class="kanmo-label">Gender<span
                                            class="kanmo-required">*</span></label>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="birth_place" name="birth_place"
                                        value="{{ old('birth_place', $user->birth_place ?? '') }}" maxlength="100"
                                        required
                                ...
                                <div>
                                    ...
                                    <input type="text" id="nationality" name="nationality"
                                        value="{{ old('nationality', $user->nationality ?? 'Indonesia') }}"
                                        maxlength="50" required
                                        class="kanmo-input {{ $errors->has('nationality') ? 'kanmo-input-error' : '' }}"
                            ...
                            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                <div>
                                    ...
                                    <input type="email" id="primary_email" name="primary_email"
                                        value="{{ old('primary_email', $user->primary_email ?? '') }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="current_provinsi" name="current_provinsi"
                                        value="{{ old('current_provinsi', $user->current_provinsi ?? '') }}"
                                        maxlength="100" @required($isEmployeeRequired('current_provinsi'))
                                ...
                                <div>
                                    ...
                                    <input type="text" id="current_kotamadya_kabupaten"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="current_kecamatan" name="current_kecamatan"
                                        value="{{ old('current_kecamatan', $user->current_kecamatan ?? '') }}"
                                        maxlength="100" @required($isEmployeeRequired('current_kecamatan'))
                                ...
                                <div>
                                    ...
                                    <input type="text" id="current_kelurahan" name="current_kelurahan"
                                        value="{{ old('current_kelurahan', $user->current_kelurahan ?? '') }}"
                                        maxlength="100" @required($isEmployeeRequired('current_kelurahan'))
                                ...
                                <div>
                                    ...
                                    <input type="text" id="ktp_kecamatan" name="ktp_kecamatan"
                                        value="{{ old('ktp_kecamatan', $user->ktp_kecamatan ?? '') }}"
                                        maxlength="100" @required($isEmployeeRequired('ktp_kecamatan'))
                                ...
                                <div>
                                    ...
                                    <input type="text" id="ktp_kelurahan" name="ktp_kelurahan"
                                        value="{{ old('ktp_kelurahan', $user->ktp_kelurahan ?? '') }}"
                                        maxlength="100" @required($isEmployeeRequired('ktp_kelurahan'))
                            ...
                            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                <div>
                                    ...
                                    <input type="text" id="mother_full_name" name="mother_full_name"
                                        value="{{ old('mother_full_name', $user->mother_full_name ?? '') }}"
                                        maxlength="100" @required($isEmployeeRequired('mother_full_name'))
                                ...
                                <div>
                                    ...
                                    <input type="text" id="major" name="major"
                                        ...
                                        @required($isEmployeeRequired('major'))
                                ...
                                <div>
                                    ...
                                    <input type="text" id="institution_name" name="institution_name"
                                        ...
                                        maxlength="150" @required($isEmployeeRequired('institution_name'))
                                ...
                                <div class="flex space-between gap-5">
                                    <div class="w-full">
                                        ...
                                        <input type="number" min="1800" max="2100" id="education_from"
                                            name="education_from"
                                            value="{{ old('education_from', $user->education_from ?? '') }}"
                                            maxlength="150" @required($isEmployeeRequired('education_from'))
                                    ...
                                    <div class="w-full">
                                        ...
                                        <input type="number" min="1800" max="2100" id="education_end"
                                            name="education_end"
                                            value="{{ old('education_end', $user->education_end ?? '') }}"
                        ...
                        <div class="kanmo-form-section-body">
                            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                <div>
                                    ...
                                    <input type="file" id="ijazah_filename" name="ijazah_filename"
                                        class="filepond" @required($isEmployeeRequired('ijazah_filename') ?? ($existingDocuments['ijazah_filename'] ?? false))
